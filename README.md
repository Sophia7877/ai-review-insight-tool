...
早期不追求“大而全”的 AI 运营平台，而是用一个高频、低门槛、结果可见的场景吸引第一批用户：

> 上传 30 条用户评论，10 分钟生成一份“用户为什么买/为什么不买”的运营复盘。

| 冷启动要素 | 项目设计 | 目的 |
| --- | --- | --- |
| 明确人群 | 电商运营、内容运营、品牌运营 | 找到每天都要处理评论和反馈的人 |
| 高频痛点 | 评论多、整理慢、选题靠感觉 | 让用户一眼判断自己是否需要 |
| 低门槛入口 | 复制评论或上传 CSV，无需接入后台 | 降低首次试用成本 |
| 即时结果 | 购买动机、流失阻碍、内容选题、FAQ | 让用户第一次使用就看到价值 |
| 可复用交付 | Markdown 周报、JSON 数据、运营链路文档 | 让结果能进入周报、复盘和内容排期 |

早期增长不是靠功能堆叠，而是靠“具体场景 + 立刻可用的结果 + 可被复用的运营交付物”。
...
- [早期用户获取策略](docs/early-adoption.md)：冷启动人群、使用钩子、触达渠道和验证指标
